> **Superseded (2026-09-11).** Kept for history. The current setup guide for the OpenAI-direct phone path is `skills/launch-web-openai/SKILL.md`; the current architecture (3-agent switcher, gpt-live-1 via the GPT-Live API) is in `AGENT_SWITCHER_SPEC.md` and `HANDOFF.md`.
