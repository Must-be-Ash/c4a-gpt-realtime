...
- [x] Artifact renders live on the dashboard — simulated a prod tool-call; **snapshot-on-connect** replayed the active call (pill "Incoming · <your-phone>" + BTC candle chart) in-browser over the internet.
...
- [ ] **NEEDS YOU:** call **<vapi-number>** from **<your-phone>** → hear the agent; ask for a BTC chart/news/balance and watch the dashboard; try a small spoken-confirmed trade on a limited-funds portfolio.
